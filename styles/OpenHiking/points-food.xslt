...
<rule  e="any" k="amenity" v="restaurant" zoom-min="15">
    ...
    <rule  e="any" k="*" v="*" zoom-min="17">
        <symbol id="restaurant" src="{$foodIconPath}/restaurant.svg" symbol-width="18" priority="{$pr-restaurant}"/>
    </rule>                         
...
<rule  e="any" k="amenity" v="fast_food" zoom-min="15">
    <symbol id="fast_food" src="{$foodIconPath}/fast_food.svg" symbol-width="17" priority="{$pr-fast-food}"/>
    <rule e="any" k="*" v="*" zoom-min="16">
...
<rule  e="any" k="amenity" v="ice_cream" zoom-min="15">
    <symbol id="ice_cream" src="{$foodIconPath}/ice_cream.svg" symbol-width="14" priority="{$pr-ice-cream}"/>
    <rule e="any" k="*" v="*" zoom-min="16">
...
<rule  e="any" k="craft" v="winery" zoom-min="15">
    <symbol id="winery" src="{$foodIconPath}/winery.svg" symbol-width="18" priority="{$pr-winery}"/>
    <rule e="any" k="*" v="*" zoom-min="16">
...
<rule  e="any" k="shop" v="confectionery|pastry" zoom-min="15">
        <symbol id="confectionery" src="{$foodIconPath}/confectionery.svg" symbol-width="22" priority="{$pr-confectionery}"/>
        <rule e="any" k="*" v="*" zoom-min="16">
