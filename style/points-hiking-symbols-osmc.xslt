...
<xsl:param name="color" />
	<rule e="node" k="{$key}" v="{$ns-symbol-osmc}whiteÉ{$color}_stripe" zoom-min="12" zoom-max="15">
	...
	<rule e="node" k="{$key}" v="{$ns-symbol-osmc}white:{$color}_dot" zoom-min="12" zoom-max="15">
		<symbol src="{$hikingSymbolPath}/osmc-white-{$color}_dot{$variant}.svg" symbol-width="{$sw-hiking-b-z14}" priority="{$pr-hiking-symbols}"/>
	</rule>
	<rule e="node" k="{$key}" v="{$ns-symbol-osmc}white:{$color}_dot" zoom-min="16">
		<symbol src="{$hikingSymbolPath}/osmc-white-{$color}_dot{$variant}.svg" symbol-width="{$sw-hiking-b-z16}" priority="{$pr-hiking-symbols}"/>
	</rule>
	<rule e="node" k="{$key}" v="{$ns-symbol-osmc}white:{$color}_cross" zoom-min="12" zoom-max="15">
		<symbol src="{$hikingSymbolPath}/osmc-white-{$color}_cross{$variant}.svg" symbol-width="{$sw-hiking-b-z14}" priority="{$pr-hiking-symbols}"/>
	</rule>
	<rule e="node" k="{$key}" v="{$ns-symbol-osmc}white:{$color}_cross" zoom-min="16">
		<symbol src="{$hikingSymbolPath}/osmc-white-{$color}_cross{$variant}.svg" symbol-width="{$sw-hiking-b-z16}" priority="{$pr-hiking-symbols}"/>
	</rule>
	<rule e="node" k="{$key}" v="{$ns-symbol-osmc}white:{$color}_triangle" zoom-min="12" zoom-max="15">
		<symbol src="{$hikingSymbolPath}/osmc-white-{$color}_triangle{$variant}.svg" symbol-width="{$sw-hiking-s-z14}" priority="{$pr-hiking-symbols}"/>
	</rule>
	<rule e="node" k="{$key}" v="{$ns-symbol-osmc}white:{$color}_triangle" zoom-min="16">
		<symbol src="{$hikingSymbolPath}/osmc-white-{$color}_triangle{$variant}.svg" symbol-width="{$sw-hiking-s-z16}" priority="{$pr-hiking-symbols}"/>
	</rule>
</xsl:template>
...
<xsl:param name="color" />
	<rule e="node" k="{$key}" v="{$ns-symbol-osmc}white:{$color}_circle" zoom-min="12" zoom-max="15">
		<symbol src="{$hikingSymbolPath}/osmc-white-{$color}_circle{$variant}.svg" symbol-width="{$sw-hiking-z14}" priority="{$pr-hiking-symbols}"/>
	</rule>
	<rule e="node" k="{$key}" v="{$ns-symbol-osmc}white:{$color}_circle" zoom-min="16">
		<symbol src="{$hikingSymbolPath}/osmc-white-{$color}_circle{$variant}.svg" symbol-width="{$sw-hiking-z16}" priority="{$pr-hiking-symbols}"/>
	</rule>
