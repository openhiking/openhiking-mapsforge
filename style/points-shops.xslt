...
<rule  e="any" k="shop" v="clothes|boutique|shoes|leather" zoom-min="16">
...
<rule  e="any" k="shop" v="doityourself|electrical|florist|garden_centre|houseware" zoom-min="16">
    <symbol id="shop" src="{$symbolPath}/shop.svg" symbol-width="20" priority="{$pr-shop}"/>
    <rule e="any" k="*" v="*" >
        <caption k="name" symbol-id="shop" 
        font-style="bold" font-size="10" fill="#666666" stroke="#ffffff" stroke-width="2"  priority="{$pr-shop}"/>
...
<rule  e="any" k="shop" v="furniture|interior_decoration|kitchen" zoom-min="16">
    <symbol id="shop" src="{$symbolPath}/shop.svg" symbol-width="20" priority="{$pr-shop}"/>
    <rule e="any" k="*" v="*" >
        <caption k="name" symbol-id="shop" 
        font-style="bold" font-size="10" fill="#666666" stroke="#ffffff" stroke-width="2"  priority="{$pr-shop}"/>
...
<rule  e="any" k="shop" v="computer|electronics|mobile_phone" zoom-min="16">
    <symbol id="shop" src="{$symbolPath}/shop.svg" symbol-width="20" priority="{$pr-shop}"/>
    <rule e="any" k="*" v="*" >
        <caption k="name" symbol-id="shop" 
        font-style="bold" font-size="10" fill="#666666" stroke="#ffffff" stroke-width="2"  priority="{$pr-shop}"/>
...
<rule  e="any" k="shop" v="butcher|cheese|chocolate|deli|farm|seafood" zoom-min="16">
    <symbol id="shop" src="{$symbolPath}/shop.svg" symbol-width="20" priority="{$pr-shop}"/>
    <rule e="any" k="*" v="*" >
        <caption k="name" symbol-id="shop" 
        font-style="bold" font-size="10" fill="#666666" stroke="#ffffff" stroke-width="2"  priority="{$pr-shop}"/>
...
<rule  e="any" k="shop" v="kiosk" zoom-min="16">
    <symbol id="shop" src="{$symbolPath}/shop.svg" symbol-width="20" priority="{$pr-shop}"/>
    <rule e="any" k="*" v="*" >
        <caption k="name" symbol-id="shop" 
        font-style="bold" font-size="10" fill="#666666" stroke="#ffffff" stroke-width="2"  priority="{$pr-shop}"/>
