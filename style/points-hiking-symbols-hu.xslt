...
<xsl:param name="color" />
	...
	<rule e="node" k="{$symbol-tag}" v="{$ns-symbol-hu}{$color}atl" zoom-min="12" zoom-max="15">
		<symbol src="{$hikingSymbolPath}/hu-{$color}atl.svg" symbol-width="{$sw-hiking-z14}" priority="{$pr-hiking-symbols-minor}" display="always"/>
	</rule>
	<rule e="node" k="{$symbol-tag}" v="{$ns-symbol-hu}{$color}atl" zoom-min="16" >
		<symbol src="{$hikingSymbolPath}/hu-{$color}atl.svg" symbol-width="{$sw-hiking-z16}" priority="{$pr-hiking-symbols-minor}" display="always"/>
	</rule>
...
<xsl:template name="hiking-symbol-hu-special-rules">
	...
	<rule e="node" k="{$symbol-tag}" v="{$ns-symbol-hu}salp" zoom-min="12" zoom-max="15">
		<symbol src="{$hikingSymbolPath}/hu-salp.svg" symbol-width="{$sw-hiking-z14}" priority="{$pr-hiking-symbols}"/>
	</rule>
	<rule e="node" k="{$symbol-tag}" v="{$ns-symbol-hu}salp" zoom-min="16" >
		<symbol src="{$hikingSymbolPath}/hu-salp.svg" symbol-width="{$sw-hiking-z16}" priority="{$pr-hiking-symbols}"/>
	</rule>
</xsl:template>

<xsl:template name="hiking-symbol-hu-ski">
	<rule e="node" k="{$ski-symbol-tag}" v="{$ns-symbol-hu}px" zoom-min="12" zoom-max="15">
		<symbol src="{$hikingSymbolPath}/hu-px.svg" symbol-width="{$sw-hiking-z14}" priority="{$pr-hiking-symbols-minor}" display="always"/>
	</rule>
	<rule e="node" k="{$ski-symbol-tag}" v="{$ns-symbol-hu}px" zoom-min="16" >
		<symbol src="{$hikingSymbolPath}/hu-px.svg" symbol-width="{$sw-hiking-z16}" priority="{$pr-hiking-symbols-minor}" display="always"/>
	</rule>

	<rule e="node" k="{$ski-symbol-tag}" v="{$ns-symbol-hu}kx" zoom-min="12" zoom-max="15">
		<symbol src="{$hikingSymbolPath}/hu-kx.svg" symbol-width="{$sw-hiking-z14}" priority="{$pr-hiking-symbols-minor}" display="always"/>
	</rule>
	<rule e="node" k="{$ski-symbol-tag}" v="{$ns-symbol-hu}kx" zoom-min="16" >
		<symbol src="{$hikingSymbolPath}/hu-kx.svg" symbol-width="{$sw-hiking-z16}" priority="{$pr-hiking-symbols-minor}" display="always"/>
	</rule>
</xsl:template>
...
<xsl:param name="level" />
	<rule e="node" k="{$ski-symbol-tag}_{$level}" v="{$ns-symbol-hu}px" zoom-min="12" zoom-max="15">
		<symbol src="{$hikingSymbolPath}/hu-px-{$level}.svg" symbol-width="{$sw-hiking-z14}" priority="{$pr-hiking-symbols-minor}" display="always"/>
	</rule>
	<rule e="node" k="{$ski-symbol-tag}_{$level}" v="{$ns-symbol-hu}px" zoom-min="16" >
		<symbol src="{$hikingSymbolPath}/hu-px-{$level}.svg" symbol-width="{$sw-hiking-z16}" priority="{$pr-hiking-symbols-minor}" display="always"/>
	</rule>

	<rule e="node" k="{$ski-symbol-tag}_{$level}" v="{$ns-symbol-hu}kx" zoom-min="12" zoom-max="15">
		<symbol src="{$hikingSymbolPath}/hu-kx-{$level}.svg" symbol-width="{$sw-hiking-z14}" priority="{$pr-hiking-symbols-minor}" display="always"/>
	</rule>
	<rule e="node" k="{$ski-symbol-tag}_{$level}" v="{$ns-symbol-hu}kx" zoom-min="16" >
		<symbol src="{$hikingSymbolPath}/hu-kx-{$level}.svg" symbol-width="{$sw-hiking-z16}" priority="{$pr-hiking-symbols-minor}" display="always"/>
	</rule>
</xsl:template>
