...
# OpenHikingMap
#
# Nordic ski route highlighting
#
# Copyright (c) 2022-2023 OpenHiking contributors
# SPDX-License-Identifier: GPL-3.0-only
-->

<xsl:template name="lines-ski-nordic">
