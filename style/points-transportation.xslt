...
<rule  e="any" k="access" v="~|yes" >
    <rule  e="any" k="amenity" v="parking" zoom-min="16">
        ...
        <rule e="any" k="*" v="*" >
            ...
            font-style="bold" font-size="10" fill="#666666" stroke="#ffffff" stroke-width="2"  priority="{$pr-parking}"/>
        </rule>       
    </rule>        
    ...
    <rule  e="any" k="amenity" v="fuel" zoom-min="16">
        ...
        <rule e="any" k="*" v="*" >
            ...
            font-style="bold" font-size="10" fill="#666666" stroke="#ffffff" stroke-width="2"  priority="{$pr-fuel}"/>
        </rule>       
    </rule>        
...
<rule  e="any" k="railway" v="station|halt" zoom-min="15">
  ...
  <rule e="node" k="*" v="*" zoom-min="16">
    ...
    font-style="bold" font-size="10" fill="#4040ff" stroke="#ffffff" stroke-width="2" priority="{$pr-train-station}"/>
  </rule>
</rule>
...
<rule  e="any" k="highway" v="bus_stop">
  ...
  <rule e="node" k="*" v="*" zoom-min="16">
    ...
    font-style="bold" font-size="10" fill="#4040ff" stroke="#ffffff" stroke-width="2" priority="{$pr-bus-station}"/>
  </rule>
</rule>
