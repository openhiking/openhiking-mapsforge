...
MAP_WRITER_CONF=tag-values=true type=$(MAP_MW_TYPE) preferred-languages=$(MAP_LANGUAGES) threads=$(MAP_WRITER_THREADS) way-clipping=$(MAP_WAY_CLIPPING) comment=$(MAP_LICENSE)
